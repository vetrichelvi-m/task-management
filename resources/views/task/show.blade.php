                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-lg-7">
                                                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                                                            <div class="card-header">
                                                                <h3 class="text-center font-weight-light my-4">View
                                                                    Task</h3>
                                                            </div>
                                                            <div class="card-body">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-floating">
                                                                            <textarea name="description" id="description" class="form-control" placeholder="Enter Description"
                                                                                style="resize: none;" readonly>{{ $task->description }}</textarea>
                                                                            <label
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="form-floating mb-3">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="assigned_user_id">file </label>
                                                                            @if ($task->file != '')
                                                                                <input class="form-control"
                                                                                    name="file"
                                                                                    value="{{ $task->file }}"
