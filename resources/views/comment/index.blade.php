        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Dashboard-Comment</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Dashboard-Comment</li>
                    </ol>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($comments as $task)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('comment.edit', $task->id) }}"
                                                    class="btn btn-sm btn-primary">Edit</a>

                                                <a href="{{ route('comment.show', $task->id) }}"
